...
<body>
	...
	<div class = "container-fluid" id="header">
		...
		<ul class="nav justify-content-center">
		  ...
		  <li class="nav-item">
		    <a class="nav-link active" href="about.php" style="margin-right: 2vw">About</a>
		  </li>
	...
	<div class = "container-fluid" id = "mainbody">
		<div class = "row" id="firsttext">
			<br/>
			<h3 align="center">Custom Controllers Inc. was founded to bring custom controllers to the masses that are intuitive and extremely beneficial to a large variety of games. </h3>
			<br/>
		</div>

		<div class = "row" id="secondtext">
			<br/>
			<h3 align="center">The team at Custom Controllers Inc. began to notice that new games, that are more complex than ever before, weren’t completely adequate for the needs of the average gamer. We noticed that many people were having to invest into a PC to unlock the full potential of a keyboard and mouse having several separate keybind opportunities. </h3>
			<br/>
		</div>

		<div class = "row" id="thirdtext">
			<br/>
			<h3 align="center">Custom Controllers Inc. wants to give an option to gamers that want more options in how they play their games, so we are introducing an entire line of custom controllers that come in different colors and customizable layouts. Go check out our store page to find the perfect option for you!</h3>
			<br/>
		</div>
